...
.PHONY: kobo-libs
kobo-libs:
	./kobo/build.py $(TARGET_OUTPUT_DIR) $(HOST_TRIPLET) $(ACTUAL_HOST_TRIPLET) "$(TARGET_ARCH)" "$(TARGET_CPPFLAGS)" "$(filter-out $(THIRDPARTY_LDFLAGS_FILTER_OUT),$(TARGET_LDFLAGS))" $(CC) $(CXX) $(AR) $(ARFLAGS) $(RANLIB) $(STRIP)

TARGET_CPPFLAGS += -I$(THIRDPARTY_LIBS_ROOT)/include
